...
{
    /// <summary>
    /// Klass för (C)R(UD)-funktionalitet mot tabellen PostType.
    /// </summary>
    [DataObject(false)]
    public class PostTypeDAL : DALBase
    {
        #region CRUD-metoder
        ...
        /// </summary>
        /// <returns>Lista med referenser till PostType-objekt.</returns>
        ...
        //            MySqlCommand cmd = new MySqlCommand("app.uspGetPostTypes", conn);
        //            cmd.CommandType = CommandType.StoredProcedure;

        //            // Skapar det List-objekt som initialt har plats för 10 referenser till PostType-objekt.
        //            List<PostType> contactTypes = new List<PostType>(10);
        ...
        //            // Returnerar referensen till List-objektet med referenser med PostType-objekt.
        //            return contactTypes;
        //        }
        //        catch
        //        {
